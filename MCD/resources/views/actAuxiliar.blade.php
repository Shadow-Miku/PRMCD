...
@section('contenido')
    ...
    <div class="container mt-5 col-md-6">
        ...
        <h1 class="display-1 text-center mb-5"> Actualizar Datos de Auxiliar </h1>
        ...
        <div class="card  mb-5 fw-bold">
            ...
            <div class="card-body">
            <form class="m-4" method="post" action="{{route('adminAuxiliar.update', $consultaId->idaux)}}">    
                @csrf
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nombre" value="{{$consultaId->nameA}}">
